...
const AdminPanel = () => {
  ...
  const fetchSubmissions = async () => {
    try {
      const res = await axios.get("https://shop-backend-45ip.onrender.com/api/forms/all");
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      await axios.post("https://shop-backend-45ip.onrender.com/api/products", formData, {
  ...
  const handleAddOffer = async (e) => {
    ...
    try {
      await axios.post("https://shop-backend-45ip.onrender.com/api/offers", formData, {
        headers: { "Content-Type": "multipart/form-data" },
        withCredentials: true,
      });
      alert("✅ Offer added!");
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this submission?")) {
      try {
        await axios.delete(`https://shop-backend-45ip.onrender.com/api/forms/${id}`, {
          withCredentials: true,
        });
        fetchSubmissions();
      } catch (err) {
